...
let guess = ""
let answer = ""
let answerKey = "a b c d e f g h i j k l m n o p q r s t u v w x y z"

const fetchWord = async() => {
    let randWord = BANK[Math.floor(Math.random()*BANK.length-1)]
    answer = randWord
}
...
const setup = () => {
    ...
    charChart.textContent = answerKey
}
...
const keyPress = (e) => {
    ...
    if(e.key == "Enter" && guess.length == 5 && BANK.includes(guess)) {
        ...
        for(let i = 0; i < guess.length; i++) {
            ...
            if(answerKey.includes(guess.charAt(i))) {
                let str = answerKey.split('')

                str.splice(answerKey.indexOf(guess.charAt(i)), 2)
                answerKey = str.join('')
            }
        }
        for(let i = 0; i < guess.length; i++) {
...
const resetGame = () => {
    ...
    grid.innerHTML = ""
    document.addEventListener("keydown", keyPress)
    answerKey = "a b c d e f g h i j k l m n o p q r s t u v w x y z"
    fetchWord()
    setup()
}
